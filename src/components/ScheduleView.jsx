                ...
                <div className="flex items-center justify-between mb-4">
                    ...
                    <div className="flex gap-2">
                        <button
                            ...
                            className={`${theme.accent} text-white px-4 py-2 rounded-xl font-bold transition-all transform hover:scale-105 hover:shadow-lg flex items-center gap-1`}
                        >
                        ...
                        <button
                            ...
                            className="px-4 py-2 border-2 border-gray-200 rounded-xl text-sm font-semibold hover:bg-red-50 hover:border-red-200 hover:text-red-600 transition-all"
                        >
                            Remove Day
                        </button>
                    </div>
